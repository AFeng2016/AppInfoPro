...
public class AppInfoBean {
    ...
    // App 类型
    private AppInfoBean.AppType appType;
    // 获取版本号
     ...
     * @return
     */
    public AppInfoBean.AppType getAppType() {
        return appType;
    }
     ...
     * @return
     */
    public static AppInfoBean.AppType getAppType(PackageInfo pInfo){
        if (!isSystemApp(pInfo) && !isSystemUpdateApp(pInfo)){
            return AppInfoBean.AppType.USER;
        }
        return AppInfoBean.AppType.SYSTEM;
    }
